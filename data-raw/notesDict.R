...
# nOct = 11
# notes_all = paste0(notes, rep(-5:(nOct - 1), each = 12)) # paste0(notes_all, collapse=', ')
# c0 = 13.75 * 2 ^ (3 / 12) # 16.3516 Hz exactly. 440 / 32 = 13.75  # A-1, and C0 is 3 semitones higher
# notes_freq = round(c0 * 2 ^ (-60:(12 * nOct - 1) / 12), 2) # paste0(notes_freq, collapse=', ')

notesDict = data.frame (
  note = c('C-5','C♯-5','D-5','D♯-5','E-5','F-5','F♯-5','G-5','G♯-5','A-5','B♭-5','B-5',
           'C-4','C♯-4','D-4','D♯-4','E-4','F-4','F♯-4','G-4','G♯-4','A-4','B♭-4','B-4',
           'C-3','C♯-3','D-3','D♯-3','E-3','F-3','F♯-3','G-3','G♯-3','A-3','B♭-3','B-3',
           'C-2','C♯-2','D-2','D♯-2','E-2','F-2','F♯-2','G-2','G♯-2','A-2','B♭-2','B-2',
           'C-1','C♯-1','D-1','D♯-1','E-1','F-1','F♯-1','G-1','G♯-1','A-1','B♭-1','B-1',
           'C0','C♯0','D0','D♯0','E0','F0','F♯0','G0','G♯0','A0','B♭0','B0',
           ...
           'C10','C♯10','D10','D♯10','E10','F10','F♯10','G10','G♯10','A10', 'B♭10','B10'),
  freq = c(0.51, 0.54, 0.57, 0.61, 0.64, 0.68, 0.72, 0.77, 0.81, 0.86, 0.91, 0.96,
           1.02, 1.08, 1.15, 1.22, 1.29, 1.36, 1.45, 1.53, 1.62, 1.72, 1.82, 1.93,
           2.04, 2.17, 2.29, 2.43, 2.58, 2.73, 2.89, 3.06, 3.24, 3.44, 3.64, 3.86,
           4.09, 4.33, 4.59, 4.86, 5.15, 5.46, 5.78, 6.12, 6.49, 6.87, 7.28, 7.72,
           8.18, 8.66, 9.18, 9.72, 10.3, 10.91, 11.56, 12.25, 12.98, 13.75, 14.57, 15.43,
           16.4, 17.3, 18.4, 19.4, 20.6, 21.8, 23.1, 24.5, 26, 27.5, 29.1,
