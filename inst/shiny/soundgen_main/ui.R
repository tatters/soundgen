                                           ...
                                           sidebarLayout(
                                             sidebarPanel(
                                               ...
                                               shinyBS::bsCollapsePanel("Subharmonics",
                                                                        sliderInput('subRatio', 'Number of subharmonics', value=permittedValues['subRatio','default'], min=permittedValues['subRatio', 'low'], max=permittedValues['subRatio', 'high'], step=permittedValues['subRatio','step']),
                                                                        sliderInput('subFreq', 'Target subharmonic frequency, Hz (overrides number of subharmonics)', value=permittedValues['subFreq','default'], min=permittedValues['subFreq', 'low'], max=permittedValues['subFreq', 'high'], step=permittedValues['subFreq','step']),
                                                                        sliderInput('subDep', 'Depth of subharmonics, %', value=permittedValues['subDep','default'], min=permittedValues['subDep', 'low'], max=permittedValues['subDep', 'high'], step=permittedValues['subDep','step']),                                                                                                                                            sliderInput('subWidth', 'Width of sidebands, Hz', value=permittedValues['subWidth','default'], min=permittedValues['subWidth', 'low'], max=permittedValues['subWidth', 'high'], step=permittedValues['subWidth','step'])
                                               ),
