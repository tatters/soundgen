  ...
  fluidRow(
    column(
      ...
      tabsetPanel(
        ...
        navbarMenu(
          ...
          tabPanel(
            "Windowing",
            numericInput('windowLength_lpc', 'Window length, ms',
            ...
            sliderInput('overlap_lpc', 'Overlap, %',
            ...
            sliderInput('dynamicRange_lpc', 'Dynamic range, dB',
        ...
        navbarMenu(
          ...
          tabPanel(
            ...
            radioButtons(inputId='spec_colorTheme', label='Color scheme',
                         choices=c("Seewave" = "seewave",
                                   "Heat" = "heat.colors",
                                   "Black & white" = "bw"),
                         selected='bw', inline=TRUE, width=NULL),
            sliderInput('specContrast', 'Contrast',
            ...
            sliderInput('specBrightness', 'Brightness',
            ...
            shinyBS::bsCollapsePanel(
              "Advanced",
              sliderInput('zp', 'Zero padding, points 2 ^ n',
                          value = def_form['zp', 'default'],
                          min = def_form['zp', 'low'],
                          max = def_form['zp', 'high'],
                          step = def_form['zp', 'step']),
              selectInput('wn', 'Window type',
                          choices = c('bartlett', 'blackman', 'flattop', 'gaussian',
                                      'hamming', 'hanning', 'rectangle'),
                          selected = 'gaussian', multiple = FALSE),
              sliderInput('spec_maxPoints', 'Max number of pixels, 10^',
          ...
          tabPanel(
            "Spectrum",
            sliderInput('spectrum_len', 'Resolution, points',
    ...
    column(
      ...
      fluidRow(
        ...
        column(
          3,
          fileInput(inputId = "loadAudio", label = NULL,
        ...
        column(
          2,
          downloadButton(outputId = "saveRes", label = "",
      ...
      fluidRow(
        column(
          plotOutput('spectrogram', height = '500px',
          ...
          plotOutput('ann_plot', height = '100px',
                     click = "ann_click",
        ...
        column(
          ...
          sliderInput('spectrum_smooth', 'Smoothing',
