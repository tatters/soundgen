...
sound = soundgen(pitch = c(150, 250, 100), 
                 sylLen = 700, play = playback)  # up and down
sound = soundgen(pitch = c(150, 200, NA, 110), 
                 sylLen = 700, play = playback)  # 3rd quarter silent
```
