# TODO: warpPitch - up/downsample and transplant formants back in; getSmoothContour - decimate with approx or spline xout; transplantFormants - check against warpFormants; check main in all plots - should be like analyze & spectrogram ('' if audio$filename_base = 'sound'); NB: turn off debug mode in pitch_app & formant_app before submitting to CRAN!
