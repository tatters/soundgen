# TODO: modify segment to detect uniform epochs within a sound and add output as an extra column returned by analyze (with modifiable threshold for what counts as "uniform"); a single function replaces shiftFormants + shiftPitch + timeStretch; implement "vocoder done right"; NB: turn off debug mode in pitch_app & formant_app before submitting to CRAN!
