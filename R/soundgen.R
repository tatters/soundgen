# TODO: analyze - check why flat osc when analyzing files; analyze - pitch 'spec' not working; modulationSpectrum - update description; check optimizePars; reverb - update input, add saveAudio, maybe always return detailed list; check for 2 uncommented playme's in examples; refer to addAM instead of segment or soundgen for saveAudio & play; analyze - calculate subh-to-harm ratio a la Sun & Xu 2002 / Herbst 2020 (or just return the max ratio of spectral peak at f0/int to the ampl of peak at f0)
