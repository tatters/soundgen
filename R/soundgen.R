...
# pitch_app: one file disappears from results when new audio is uploaded; see a list of all uploaded files (add button - doing it with tooltips doesn't work); load audio + results to double-check old work
