# TODO: check optimizePars; reverb - update input, add saveAudio, maybe always return detailed list; check for 2 uncommented playme's in examples; refer to addAM instead of segment or soundgen for saveAudio & play
