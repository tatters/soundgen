# TODO: check for 2 uncommented playme's in examples; refer to addAM instead of segment or soundgen for saveAudio & play; check main in all plots - should be like analyze & spectrogram ('' if audio$filename_base = 'sound')
