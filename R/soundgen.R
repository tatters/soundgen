# TODO: analyze() - adaptive priors; think about how best to normalize amDep; check main in all plots - should be like analyze & spectrogram ('' if audio$filename_base = 'sound'); NB: turn off debug mode in pitch_app & formant_app before submitting to CRAN!
