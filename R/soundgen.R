# TODO: analyze - remove or fix voicedSeparate; analyze etc - add error-proof operation a la segment; deprecate all Folder functions - just accept a file or a folder as input; ssm - option to calculate incomplete ssm (just enough to get a novelty contour, even for very long sounds); maxPoints in ssm or maybe just in contour_mod; analyze - extra par lists NULL means don't analyze (roughness, ssm);
