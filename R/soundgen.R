# TODO: am detection in analyze() - low-pass below f0 and look for peaks; check main in all plots - should be like analyze & spectrogram ('' if audio$filename_base = 'sound'); NB: turn off debug mode in pitch_app & formant_app before submitting to CRAN!
