# TODO: find out why no global binding for x in segmentSound; analyze etc - add error-proof operation a la segment; deprecate all Folder functions - just accept a file or a folder as input; step correction to integer step_points in analyze etc a la segment();
