# TODO: formant_app - VTL not updated when clicking spectrum only spetrogram; think about how best to normalize amDep; reportTime - show %done, max 2 time levels (eg days + h, remove min & s); check main in all plots - should be like analyze & spectrogram ('' if audio$filename_base = 'sound'); NB: turn off debug mode in pitch_app & formant_app before submitting to CRAN!
