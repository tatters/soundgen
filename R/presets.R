...
presets = list(
  M1 = list(
    ...
    Sigh = 'soundgen(sylLen = 50, pitchAnchors = NULL, pitchAnchorsGlobal = NULL, temperature = 0.1, formants = list(f1 = 860, f2 = 1430, f3 = 2900), vocalTract = 17, noiseAnchors = list(time = c(-20, 104, 756, 1252), value = c(26, 40, 23, -22)))',
