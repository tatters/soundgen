...
#' @return Returns a vector of percentages indicating how much a given formant
#'   is higher (positive values) or lower (negative values) than expected based
#'   on the estimated formant dispersion.
#' @param formants a numeric vector of observed formant frequencies, Hz
...
formantDev = function(formants,
  ...
  formants_theor = (2 * idx - 1) / 2 * formantDispersion
  return((formants / formants_theor - 1) * 100)
}
